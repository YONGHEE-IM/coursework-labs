...
ALTER TABLE `article` MODIFY `id` INT UNIQUE;
...
ALTER TABLE `article` MODIFY COLUMN `id` INT FIRST;
...
ALTER TABLE `article` MODIFY COLUMN `witer` VARCHAR(100) NOT NULL;
...
INSERT INTO `article` (`regDate`, `title`, `body`, `nickname`, `hit`) VALUES(NOW(), '제목3', '내용3', '홍길순', 10);

# article 테이블에 데이터 추가(regDate = NOW(), title = '제목4', body = '내용4', nickname = '홍길동', hit = 55)
INSERT INTO `article` (`regDate`, `title`, `body`, `nickname`, `hit`) VALUES(NOW(), '제목4', '내용4', '홍길동', 55);

# article 테이블에 데이터 추가(regDate = NOW(), title = '제목5', body = '내용5', nickname = '홍길동', hit = 10)
INSERT INTO `article` (`regDate`, `title`, `body`, `nickname`, `hit`) VALUES(NOW(), '제목5', '내용5', '홍길동', 10);

# article 테이블에 데이터 추가(regDate = NOW(), title = '제목6', body = '내용6', nickname = '임꺽정', hit = 100)
INSERT INTO `article` (`regDate`, `title`, `body`, `nickname`, `hit`) VALUES(NOW(), '제목6', '내용6', '임꺽정', 100);
